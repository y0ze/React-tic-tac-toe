    ...
    <div class="startMenu">
      <div class="container">
          ...
          <p class="playerNamesP">Enter Player Names:</p>
            <div class="col-3">
              <input type="text" class="effect-7" id="player1-name" placeholder="Player 1 with X" minlength="2"></input>
              <span class="focus-border"></span>
            </div>
            <div class="col-3">
              <input type="text" class="effect-7" id="player2-name" placeholder="Player 2 with O" minlength="2"></input>
              <span class="focus-border"></span>
            </div>
          </div>
